package ch.ibw.appl.apiedi.server.behandlungen.infra;
...
import ch.ibw.appl.apiedi.server.behandlungen.service.BehandlungRepository;
  ...
  public BehandlungSQL2ORepository(boolean isTest) {
    if(isTest){
      ...
      try(Connection conn = sql2o.open()){
        executeFile(conn, "C:\\Users\\mvink\\Documents\\Applikations-Entwicklung\\Privat\\A-PiediApp\\apiedi-java-server\\src\\main\\resources\\META-INF\\createtableBehandlung.sql");
        executeFile(conn, "C:\\Users\\mvink\\Documents\\Applikations-Entwicklung\\Privat\\A-PiediApp\\apiedi-java-server\\src\\main\\resources\\META-INF\\testdata.sql");
      }
    }else{
